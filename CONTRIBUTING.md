...
```bash
$ git clone git@github.com:username/delite-contacts-app.git
```

This will clone your fork to your current path in a directory named `delite-contacts-app`.
...
$ git remote add upstream git@github.com:ibm-js/delite-contacts-app.git
$ git fetch upstream
```
